...
using ElasticDataToTridion.Logger;
using System;
...
namespace ElasticDataToTridion.TridionObjects
{
    public class TridionComponent
    {
        ...
        public static string GenerateComponent(ICoreServiceFrameworkContext coreService, string xml, string schemaID, EnumType.SchemaType schemaType, string folderUri, string title, string ext_Name)
        {
            ...
            {
                Logger.Logger.WriteException(Logger.Logger.LogLevel.ERROR, "There is some error while calling GenerateComponent method", ex);
                return "";
            }
        }
        #endregion
